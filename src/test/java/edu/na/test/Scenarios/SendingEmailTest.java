...
public class SendingEmailTest {
    ...
    public void SendingEmailTest() throws InterruptedException {
        ...
        driver.findElement(By.linkText("Course Information")).click();
        Thread.sleep(2000);
        driver.findElement(By.id("pg0_V_rptFaculty_ctl00_EmailAddress")).click();
        Thread.sleep(2000);
        driver.findElement(By.name("pg0$V$SubjectTextBox")).sendKeys("Test For Sending Email");
        Thread.sleep(2000);
        driver.switchTo().frame("pg0_V_BodyTextEditor_ctl00_ifr");
        driver.findElement(By.id("tinymce")).sendKeys("This email is sending for to test sending email page in Course information page");
