...
public class DownloadProjectProposalPresentation {
    WebDriver driver;
    ...
    public void DownloadProjectProposalPresentation() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("pg0_V_CardLayoutControl_cardSetsRepeater_ctl00_cardsInSetRepeater_ctl03_NonAdminButtonLink")).click();
