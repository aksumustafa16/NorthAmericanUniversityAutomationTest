...
public class DownloadSyllabus {
    ...
    @Test
    public void DownloadSyllabus() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("pg1_V_CardLayoutControl_cardSetsRepeater_ctl00_cardsInSetRepeater_ctl00_titleLink")).click();
