...
public class PrintDueNextAssigments {
    ...
    public void PrintDueNextAssigments() throws InterruptedException {
        ...
        Thread.sleep(2000);
        System.out.println("First assignment:" + driver.findElement(By.id("pg0_V__dueNext__rptDueNext_ctl00__hypAssign")).getText());
        System.out.println("Second assignment:" + driver.findElement(By.id("pg0_V__dueNext__rptDueNext_ctl01__hypAssign")).getText());
